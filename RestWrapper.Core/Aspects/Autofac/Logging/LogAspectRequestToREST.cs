...
{
    public class LogAspectRequestToREST : BaseLogAspect
    {
        private LoggerServiceBase _loggerServiceBase;

        public LogAspectRequestToREST(Type loggerService)
        {
        ...
        public override string GetLogMessage(IInvocation invocation)
        {
            ...
            //var message = LogFormats.RequestToREST(callOrderer, parameters[0].Value, parameters[1].Value);
            return "";
        }
    }
}
